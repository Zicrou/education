class MetiersController < ApplicationController
  ...
  access [:user, :professeur, :principale, :censeur, :proviseur] => {except: [:index, :destroy, :create, :edit, :update, :new, :show]}, site_admin: :all, trusted: [:index, :create, :edit, :update, :new, :show, {except: [:destroy]}], respons_zone: [:index, :new, :create, :edit, :update, :show, {except: [:destroy]}]
